...
public class FileAndTimeUtility {
	 ...
	 * of the escaping when the string is parsed into words. TODO: Create a
	 * <i>String unescape(String s)</i> method that is the inverse of this one.
	 * 
	 * @param str
	 * @return
	 */
